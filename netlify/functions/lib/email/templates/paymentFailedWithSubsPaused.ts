export const paymentFailedWithSubsPausedBody = `<div style="font-family: Helvetica,Arial,sans-serif;min-width:750px;overflow:auto;line-height:2">
...
export const paymentFailedWithSubsPausedSubject = `[Action Required] Your Reminder App Premium License subscription was paused`;
